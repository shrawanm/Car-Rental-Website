...
function init() {
  ...
  const container = document.getElementById('nissan-container');
  ...
  loader.load(
    'https://raw.githubusercontent.com/Shraddhey97/3dmodel/refs/heads/main/nissan_gtr_r34_skyline__gt-r_skyline.glb',
    (gltf) => {
      carModel = gltf.scene;
